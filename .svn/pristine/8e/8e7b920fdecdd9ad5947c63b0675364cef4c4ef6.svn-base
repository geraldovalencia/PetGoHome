							...
							<div class="tab-content no-padding">
								...
								<ul >
									...
									<c:if test="${dog.possuiTag == 'false'}">
										<li><strong>TAG:</strong> <span class="txt-red">Não
												possui</span></li>
									</c:if>
									...
									<c:if test="${dog.descricao == ''}">
										<li><textarea id="rules" class="form-control" style="cursor: pointer;">Nenhuma descrição.</textarea></li>
									</c:if>
						...
						<div class="nav-tabs-custom">
							...
							<div class="tab-content no-padding">
								...
								<ul>
									...
									<li><strong>Raça:</strong> ${gato.racaGato.nomeRacaGato}</li>
...
<c:if test="${gatos == null && dogs == null}">
	...
	<div class="hero-unit"
		...
		<div class="txt-1" align="center">
			...
			<br>
			<p>É muito fácil cadastrar um Pet. Clique no botão abaixo.</p>
			<p>É gratuito e rápido. Proteja seu melhor amigo.</p>
			<br>
			<p>
