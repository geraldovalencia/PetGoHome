...
public class VincularTagPet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		// Recebe o clique que será feito na página de Pets cadastrados
			...
			if (idDog != null && idGato == null) {// Entra aqui se for Cachorro
				...
				if (idDog != null && pf.getId() == Long.parseLong(idPessoa)) {
					...
					try {
						...
						messageErro = "<div id='msgAlerta' style='width:30%'  align='center' class='alert alert-danger'><button type='button' class='close' data-dismiss='alert'>&times;</button><span><img src='img/exclamacao.png' /></span><h5>Erro sem conexão com o Banco de Dados.</h5></div>";
	...
	protected void doPost(HttpServletRequest request,
		...
		// Envia para cá depois de vincular
		...
		String message = "<div id='msgAlerta' style='width:30%'  align='center' class='alert alert-success'><button type='button' class='close' data-dismiss='alert'>x</button><h5>Vínculo realizado com sucesso...</h5></div>";

		String messageErro = "<div id='msgAlerta' style='width:30%'  align='center' class='alert alert-danger'><button type='button' class='close' data-dismiss='alert'>&times;</button><span><img src='img/exclamacao.png' /></span><h5>Erro! Problemas na vinculação.</h5></div>";
							...
							for (Tag tag : tags) {
								if (tag.getValorTag().equals(valorTag)) {
									...
									try {
										...
										System.out.println(e.getMessage());
										messageErro = "<div id='msgAlerta' style='width:30%'  align='center' class='alert alert-danger'><button type='button' class='close' data-dismiss='alert'>&times;</button><span><img src='img/exclamacao.png' /></span><h5>Erro em salvação do vínculo da Tag. Já existe um Pet vinculado a essa Tag.</h5></div>";
