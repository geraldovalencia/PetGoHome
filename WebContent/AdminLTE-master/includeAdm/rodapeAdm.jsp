   <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2014-2015 <a style="color: #eb6f25;" href="http://www.petgohome.com.br">PETGOHOME</a>.</strong> All rights reserved.
      </footer>
    </div><!-- ./wrapper -->
    ...
    <!-- Bootstrap WYSIHTML5 -->
    <script src="AdminLTE-master/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js" type="text/javascript"></script>
    <!-- iCheck -->
    ...
    <!-- Javascript de paginação -->
     <script src="AdminLTE-master/dist/js/jquery.form.js" type="text/javascript"></script>
     <script src="js/bootstrap-table-all.js" type="text/javascript"></script>
  </body>
</html>