...
<html>
  <head>
    <meta charset="UTF-8">
    <title>PetGoHome - Seu melhor amigo Sempre Seguro</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <link rel="shortcut icon" href="favicon.ico" />
    <!-- Fonte do Petgo e outros ajustes de CSS -->
    <link href="AdminLTE-master/bootstrap/css/styleAdm.css" rel="stylesheet" type="text/css" />
    <!-- Bootstrap 3.3.2 -->
    ...
    <link href="AdminLTE-master/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css" rel="stylesheet" type="text/css" />
