...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active">Registar Gato</li>
	</ol>
</section>
...
<section class="content">
	...
	<div class="row">
		<div class="col-xs-12 col-md-12" style="margin-bottom: 3%;">
			...
			<div align="center">
				<h3 class="laranja semiTitulo">Registar Gato</h3>
					<small>Preencha todos os dados. É importante enviar uma foto do seu PET.</small>
			</div>
		</div>
		<br>
	</div>
	<div class="row">
			...
			<div class="nav-tabs-custom">
				...
				<div class="tab-content no-padding">
					...
					<form id="contact-form" action="Cadastro-Animal-Gato.pets" class="formulario"
					...
					<div id="msgSenhaErrada" align="center"></div>
						...
						<div class="form-group">
							...
							<input class="form-control"
								...
								name="nomeGato" autofocus> 
							
						</div>
						<div class="form-group">
							<label>Raça </label><select name='racaGato'
								class="form-control" required="required">
									<option value=''>-- Selecione a Raça --</option>
									<c:forEach var="raca" items="${racas}">
										<option value='${raca.id}'>${raca.nomeRacaGato}</option>
						...
						<span><strong></strong></span>
							<label>Descrição física do seu Pet</label> <textarea name="descricao"   class="form-control"
									placeholder="Descrição: breve do pet (tamanho, cor) e mais informações relevantes, como observações médicas: "></textarea>
