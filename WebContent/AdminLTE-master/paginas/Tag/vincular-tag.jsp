					...
					<tr>
						<c:if test="${gato != null || dog != null}">
							...
							<c:if test="${dog != null}">
								...
								<td style="width: 60%;">
									<p>Digite o valor numérico da TAG aqui.</p>
									...
									<form id="contact-form" action="Vincular-Tag-dos.pets"
										...
										<label class="name">Código da TAG</label> <input type="text"
											id="valorTag" placeholder="Número da TAG:"
								...
								<td style="width: 60%;">
									...
									<form id="contact-form" action="Vincular-Tag-dos.pets"
										...
										<input type='hidden' name='idGatoVinculado'
											...
											<label class="name">Código da TAG</label>
											 <input type="text" id="valorTag"
											placeholder="Número da TAG:" class="form-control"
